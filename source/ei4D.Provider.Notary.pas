...
uses
  ei4D.Provider.Register, ei4D.Provider.Aruba, ei4D.Provider.OSItalia;

{ TeiNotary }

class procedure TeiProviderNotary.BuildProviderRegister;
begin
  // ARUBA
  ...
  // OSItalia
  TeiProviderRegister.RegisterProviderClass<TeiProviderOSItalia>(
    'OSItalia_TEST',
    'http://testi4dservice.ositalia.eu',
    'http://testservice.ositalia.eu');
end;
