...
type
  ...
  protected
    ...
    class procedure SanitizeEuroChar(var AXMLText: string);
  public
    // Refine out XML prior to save it to file/stream/string
    class procedure RefineOutXML(var AXMLText: string);
...
uses System.StrUtils, System.SysUtils, System.Classes, ei4D.Exception;
...
class procedure TeiSanitizer.SanitizeEuroChar(var AXMLText: string);
begin
  AXMLText := AXMLText.Replace('€', '&#8364;', [rfReplaceAll]);
end;

class procedure TeiSanitizer.RefineOutXML(var AXMLText: string);
begin
  SanitizeEuroChar(AXMLText);
